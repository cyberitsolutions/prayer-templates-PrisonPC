...
<p>The Webmail system uses its own addressbook.  It does not use the same
...
Pine format addressbook, you will need to import it into Webmail.</p>
...
<li> export your Webmail addressbook to a Pine or Outlook format addressbook 
...
<p>The Webmail can import and export two different forms of addressbook.
...
<li> To transfer a Pine or CSV address book from your local system into the
     Webmail system, <i>Browse</i> to the location of the address book on
     your local disk, select the appropriate file, then select
     <i>Import</i>.  The entries will be merged with any entries you
     already have in your Webmail addressbook.  New entries will appear at
     the end of your Webmail addressbook.
</li>
<li> To transfer your Webmail address book to your local system, select
...
<li> To import your Pine addressbook on <% $g_service_name |h %> into your Webmail
     ...
     in your Webmail addressbook.  New entries will appear at the end 
     of your Webmail addressbook.
</li>
<li> To export your Webmail addressbook for use with Pine on <% $g_service_name |h %>
