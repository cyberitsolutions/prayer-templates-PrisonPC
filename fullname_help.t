%# $Cambridge: hermes/src/prayer/templates/cam/fullname_help.t,v 1.1 2008/09/16 10:52:45 dpc22 Exp $
<hr class="helpsep" />

<p>User accounts are set up on Computing Service systems such as <% $g_service_name |h %>
...
replace their initials in the other name field with their given name. 
This is the purpose of this, <i>Change Fullname</i>, option. </p>
...
and the result shown as the <i>Current Fullname</i> entry.
To change your entry on <% $g_service_name |h %> enter the name you would 
like to appear in the <i>Fullname</i> field and then select the 
<i>Change Fullname</i> button.</p>

<p>The name that you choose should clearly identify you - using
just your first name is not likely to uniquely identify you.  Please bear
in mind that some "joke" names may be offensive to others. The local
database containing your real name is updated once every night.</p>
